function enemychar_load()
  enemyActors = {}
  enemyActors[1] = {speed = 30, turnPts = 10, moveAI = 1, combatAI = 1, eyesight = 5, health = 10, abilities = {}, weapon = 2, type = 1, img = 1}
  enemyActors[2] = {speed = 120, turnPts = 10, moveAI = 1, combatAI = 1, eyesight = 5, health = 10, abilities = {}, weapon = 2, type = 2, img = 1}
end
